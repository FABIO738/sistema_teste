...
class ContaReceberList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setOrderCommand('cliente->nome', '(SELECT nome FROM cliente WHERE cliente.id = conta_receber.cliente_id)');
        ...
        $id = new TEntry('id');
        $cliente_id = new TDBUniqueSearch('nome', 'curso', 'Cliente', 'id', 'nome');
        ...
        $this->form->addFields( [ new TLabel('Pessoa') ], [ $cliente_id ] );
        ...
        $column_cliente_id->setAction(new TAction([$this, 'onReload']), ['order' => 'dt_vencimento']);
